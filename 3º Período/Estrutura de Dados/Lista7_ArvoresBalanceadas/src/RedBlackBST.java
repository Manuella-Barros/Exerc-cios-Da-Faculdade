...
public class RedBlackBST<Key extends Comparable<Key>, Value> {
    ...
    private Key ultimoAcesso; // a ultima chave acessada, put or get
    ...
    private int alturaNegraRecursiva(Node no){
        ...
        if(no.left != null && no.left.color){ // é true se for vermelho
            alturaEsq = alturaNegraRecursiva(no.left);
        } else{
            alturaEsq = alturaNegraRecursiva(no.left) + 1;
        }

        alturaDir = alturaNegraRecursiva(no.right) + 1;
    ...
    /******************************** EXERCICIO 4 ********************************/
    public void setUltimoAcesso(Key key){
        this.ultimoAcesso = key;
    }
    public Key getUltimoAcesso(){
        return ultimoAcesso;
    }

    public void imprimePreOrdem(){
        imprimePreOrdemRecursiva(this.root);
    }

    private void imprimePreOrdemRecursiva(RedBlackBST.Node no){
        System.out.printf("<");

        if(no != null){
            System.out.printf("%s", no.val);
            imprimePreOrdemRecursiva(no.left);
            imprimePreOrdemRecursiva(no.right);
        }
